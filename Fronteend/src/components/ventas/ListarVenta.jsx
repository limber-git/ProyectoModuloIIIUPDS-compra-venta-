...
import DetailVentaModal from './insertardetalleventa'; 
  ...
  return (
    <div className="lista-ventas">
        ...
        <tbody>
          {filteredVentas.map(venta => (
            <tr key={venta.idventa}>
              ...
              <td>
                <button onClick={() => handleDetail(venta)}>Detalle</button>
      ...
      <Modal
        ...
        contentLabel="Modal Detalle Venta"
        className="modal-detalle-venta"
        overlayClassName="modal-overlay"
      >
        {detailVenta && (
          <DetailVentaModal detalleVenta={detailVenta} onClose={() => setShowDetailVentaModal(false)} />
        )}
      </Modal>
